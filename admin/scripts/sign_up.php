...
//        if (!$mail->send()) {
        if (!true) {
            ...
            $user_insert_query = "INSERT INTO `tbl_user` (`user_id`, `first_name`, `last_name`, `user_email`, `user_password`, `hash`, `user_country`) VALUES (NULL, :fname, :lname, :email, :pword, :hash, :country);";
